...
```
npm install -g nodemon / nodemon dist              -> Visulalizamos en terminal los console log
npm install express                                -> Crea un server web res
npm install express-graphql graphql --save         -> Graphql endpoint to express
npm install graphql-tools                          -> Tools graphql
